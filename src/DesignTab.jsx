        ...
        <div style={{ display:"flex", flexWrap:"wrap", gap:8, alignItems:"flex-start" }}>
          ...
          <div style={{ flex:"1 1 210px", minWidth:200 }}>
            <PinCard title="Plywood" cols={1}>
              ...
              <PinRow label="Max SW type" grow><select value={d.maxType} onChange={(e)=>setDk("maxType",+e.target.value)} style={{ ...pinSelS, width:"100%", flex:"1 1 auto", minWidth:0 }}><option value={1}>1</option><option value={2}>2</option><option value={3}>3</option><option value={4}>4 (2-sided)</option><option value={5}>5 (2-sided)</option><option value={6}>6 (2-sided)</option></select></PinRow>
