...
*Updated: 2026-06-25 · **rev 62 / APP_BUILD 141**. Current frontier: SEISMIC INTO THE DESIGN TAB. rev 62 wires the **1-story** per-line seismic reaction into the Design-tab demand — each line now carries its own seismic force, the engine envelopes wind vs seismic per element, and the results show a per-element governing W/S badge. Next (rev 63): 2-story seismic stacking + the upper-story-DL correction. Full detail: §4zzk.*
